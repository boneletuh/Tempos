...
struc VesaInfoBlock				;	VesaInfoBlock_size = 512 bytes
	...
	.VideoModesOffset		resw 1		; offset of pointer to the array of mode numbers (16 bits and 0xffff terminated)
	.VideoModesSegment		resw 1		; segment of the pointer in VideoModesOffset
...
VBE_VesaInfoBlock_pointer equ 0x700 ; 0x700-0xAFF
VBE_ModeInfoBlock_pointer equ 0x500	; 0x500-0x6FF
